 ...
 * @throws Exception
 */
function individual_request_element(): void
{
    vc_map(array(
        'name' => 'طلبات الأفراد',
        'base' => 'car-individual-request',
...
add_action('vc_before_init', 'individual_request_element');


/**
 * Shortcode to display individual request
 *
 * @param $data
 * @return string HTML content.
 */
function individual_request_shortcode($data): string
{
    // Extract and sanitize the shortcode attributes

    $request_type = str_contains($_SERVER['REQUEST_URI'], 'buy') ? 'شراء' : 'تجربة';
                    ...
                    <section class="product__section pt-3">
                        <div class="container">
                            ...
                            <div class="product__section--inner companies-forms">
                                ...
                                <form method="POST" class="contact__form--inner" id="individual_request_form" name="individual_request_form" action="#">
                                    <input class="comp__form--input" name="as-individual-type" value="' . $request_type . '" type="hidden">
                                    <input class="comp__form--input" name="as-individual-car" value="'.$_GET['id'].'" type="hidden">
                                            <div class="row">
                                                <div class="col-12">
<div class="comp__form--list mb-20">
        <label class="comp__form--label" for="carName">اسم السيارة<span class="contact__form--label__star">*</span></label>
        <input class="comp__form--input comp__form--input-disabled" name="as-individual-car-name" id="carName" placeholder="اسم السيارة" value="'.$title.'" type="text">
    </div>
                                                </div>
                                                <div class="col-12">
    <div class="comp__form--list mb-20">
        <label class="comp__form--label" for="carPrice">السعر<span class="contact__form--label__star">*</span></label>
        <input class="comp__form--input comp__form--input-disabled" name="as-individual-price" id="carPrice" placeholder="السعر" value="'.$price.'" type="text">
    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="switch-field">
                                                            <input required type="radio" id="radio-one" name="as-individual-payment-method" value="كاش" checked/>
                                                            <label for="radio-one">كاش</label>
                                                            <input required type="radio" id="radio-two" name="as-individual-payment-method" value="تمويل"/>
                                                ...
                                                <div class="col-12">
                                                    <div class="comp__form--list mb-20">
                                                        <label class="comp__form--label" for="input1">الاسم<span
                                                                    class="contact__form--label__star">*</span></label>
                                                        <input required class="comp__form--input" name="as-individual-name" id="input1"
                                                ...
                                                <div class="col-12">
                                                    <div class="comp__form--list mb-20">
                                                        ...
                                                        <input required class="comp__form--input" name="as-individual-email" id="input2"
                                                               placeholder="ادخل البريد الالكتروني" type="email">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="comp__form--list mb-20">
                                                        <label class="comp__form--label" for="input4">رقم الجوال <span
                                                                    class="contact__form--label__star">*</span></label>
                                                        <input required class="comp__form--input" name="as-individual-mobile" id="input4"
                                                ...
                                                <div class="col-12">
                                                    <div class="comp__form--list mb-20">
                                                        <label class="comp__form--label" for="input4">المدينة <span
                                                                    class="contact__form--label__star">*</span></label>
                                                        <select required class="comp__form--input" name="as-individual-city" id="input4">
...
<script>
        ...
        jQuery(document).ready(function($) {
            $("#carName, #carPrice").on("keydown", function(event) {
            ...
            new AjaxFormManager(
                ...
                function() { // Dynamic title generation
                    var contactNameElements = document.getElementsByName("as-individual-name");
                    var contactName = contactNameElements.length > 0 ? contactNameElements[0].value : "";
                    return "طلب '. $request_type .' من " + contactName;
                },
                function(response) { // onSuccess
                    notifyMessage("success", "لقد تم ارسال طلبك بنجاح");
                    console.log(response);
                    document.getElementById("individual_request_form").reset();
                },
                function(response) {
...
add_shortcode('car-individual-request', 'individual_request_shortcode');