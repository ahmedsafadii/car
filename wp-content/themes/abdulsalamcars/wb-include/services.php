 ...
 * @throws Exception
 */
function services_element(): void
{
    vc_map(array(
        'name' => 'الخدمات',
        'base' => 'car-services',
...
add_action('vc_before_init', 'services_element');
 ...
 */
function services_shortcode($data): string
{

    $data = shortcode_atts(array(), $data, 'car-brands');
    ...
    foreach ($packages as $package) {
        $price = get_post_meta($package->ID, 'as-package-price', true);
        $description = get_post_meta($package->ID, 'as-package-description', true);
        $title = $package->post_title;

        $packages_html .= '<div class="col-md-4">
                    <div class="card mb-4 rounded-16 border-0  py-5">
                        <div class="">
                            <span class="p-2 bg-soft-primary rounded-circle">
                                <svg width="50" height="50" viewbox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M46.5719 33.5051V13.623C46.5719 12.1528 44.7589 11.4571 43.7754 12.5499L37.6717 19.3317C36.9619 20.1204 35.6957 20.015 35.126 19.1198L30.172 11.335C29.2715 9.91987 27.2057 9.91988 26.3052 11.335L21.3512 19.1198C20.7815 20.015 19.5153 20.1204 18.8055 19.3317L12.7018 12.5499C11.7183 11.4571 9.90527 12.1528 9.90527 13.623V33.5051C9.90527 38.5677 14.0093 42.6718 19.0719 42.6718H37.4053C42.4679 42.6718 46.5719 38.5677 46.5719 33.5051Z" fill="#C6B41A"></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M20.79 36.9426C20.79 35.9934 21.5595 35.2239 22.5088 35.2239H33.9671C34.9164 35.2239 35.6859 35.9934 35.6859 36.9426C35.6859 37.8919 34.9164 38.6614 33.9671 38.6614H22.5088C21.5595 38.6614 20.79 37.8919 20.79 36.9426Z" fill="#0B0B0B"></path>
                                </svg>
                            </span>
                        </div>
                        <div class="card-body">
                            <h2 class="text-primary">' . $price . ' ريال</h2>
                            <h3>'. $title .'</h3>
                            <ul class="list-unstyled mt-3 mb-4">
                                <li>'. $description .'</li>
                            </ul>
                            <a class="primary__btn slider__btn mt-3 " href="#">شراء الخدمة</a>
                        </div>
                    </div>
                </div>';
    }
    ...
    <section class="hero__slider--section bg-light pt-5">
        ...
        <div class=" slider__thumbnail--style5 position-relative">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-md-4">
                        <div class="">
                            <span class="p-2 bg-white rounded-circle">
                                <svg width="50" height="50" viewbox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M46.5719 33.5051V13.623C46.5719 12.1528 44.7589 11.4571 43.7754 12.5499L37.6717 19.3317C36.9619 20.1204 35.6957 20.015 35.126 19.1198L30.172 11.335C29.2715 9.91987 27.2057 9.91988 26.3052 11.335L21.3512 19.1198C20.7815 20.015 19.5153 20.1204 18.8055 19.3317L12.7018 12.5499C11.7183 11.4571 9.90527 12.1528 9.90527 13.623V33.5051C9.90527 38.5677 14.0093 42.6718 19.0719 42.6718H37.4053C42.4679 42.6718 46.5719 38.5677 46.5719 33.5051Z" fill="#C6B41A"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M20.79 36.9426C20.79 35.9934 21.5595 35.2239 22.5088 35.2239H33.9671C34.9164 35.2239 35.6859 35.9934 35.6859 36.9426C35.6859 37.8919 34.9164 38.6614 33.9671 38.6614H22.5088C21.5595 38.6614 20.79 37.8919 20.79 36.9426Z" fill="#0B0B0B"/>
                                </svg>
                            </span>
                            <h2 class="hero__content--style5__title h1">باقة الضمان المتميز</h2>
                            <br>
                            <a class="primary__btn slider__btn ms-3 " href="#">
                                شراء الخدمة
                            </a>
                        </div>
                    </div>
                    <div class="col-md-7">
                        ...
                        <img class="slider__thumbnail--img__style5" src="' . $uri . '/assets/img/service-1.png" alt="slider-img">
                    </div>
    ...
    <section class="  categories__section features__section section--padding pt-0">
        <div class="container">
            <div class="row py-5">
                <div class="col-md-3">
                    <h2>نضمن لك سيارتك الجديدة</h2>
                </div>
                <div class="col-md-9">
                    <p>
                        نحن في مجموعة صالح للسيارات نقدم باقة «خلّك بالمضمون» وهو ضمان ممتد يصل لـ كيلومتر مفتوح أو نصف مليون كيلومتر لمدة 5 سنوات تبدأ بعد إنتهاء ضمان الوكيل . علمأ بأنه يمكنك شراء هذا الضمان على اي سيارة تشتريها من اي مكان . و هذا ما يتميز به ضماننا ويشمل كافة الأجزاء الهامة و المكلفة في السيارة وهي :
                    </p>
                </div>
                        ...
                        <a class="categories__card--link" href="#">
                            <span class="categories__icon mb-3">
                                <svg width="36" height="47" viewbox="0 0 36 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M19.2306 18.4436V1.54826H29.5883L29.5878 0H6.86128V1.54826H17.219V18.4565C12.9606 18.6703 8.9929 20.0458 5.94709 22.391C2.62389 24.9489 0.793964 28.3492 0.794922 31.9656C0.794922 32.3929 1.24528 32.7396 1.80038 32.7396H10.8977C11.392 35.5153 14.4851 37.6633 18.2254 37.6633C21.9657 37.6633 25.0584 35.5153 25.5532 32.7396H34.9775C35.5326 32.7396 35.9829 32.3929 35.9829 31.9656C35.9829 29.3595 35.0186 26.8292 33.1947 24.6474C30.0894 20.9339 24.9149 18.651 19.2305 18.444L19.2306 18.4436ZM18.2246 36.1139C15.5959 36.1139 13.4035 34.6574 12.9294 32.7384H23.5205C23.0458 34.6578 20.8534 36.1139 18.2247 36.1139H18.2246ZM24.6493 31.1902C24.6404 31.1902 24.6325 31.188 24.6231 31.188C24.6138 31.188 24.6058 31.1902 24.5969 31.1902H11.8515C11.8426 31.1902 11.8346 31.188 11.8253 31.188C11.8159 31.188 11.808 31.1902 11.7991 31.1902H2.83695C3.07639 28.2787 4.66412 25.5664 7.36861 23.4839C10.3121 21.2178 14.2245 19.9702 18.3853 19.9702C23.7124 19.9702 28.6167 22.0314 31.5031 25.4839C32.937 27.1988 33.7703 29.157 33.9396 31.1905L24.6493 31.1902Z" fill="currentColor"></path>
                                    <path d="M18.3848 21.5085V23.0568C22.3426 23.0568 25.987 24.5888 28.1331 27.1544C28.648 27.7707 29.0624 28.4341 29.364 29.1266L31.2716 28.6349C30.9171 27.8207 30.4303 27.041 29.8247 26.3167C27.3063 23.3059 23.0296 21.5086 18.3848 21.5086V21.5085Z" fill="currentColor"></path>
                                    <path d="M17.2188 43.8998V46.4452H19.2302V39.9722H17.2188V43.8998Z" fill="currentColor"></path>
                                    <path d="M5.53544 42.7204L4.11328 41.6257L10.0914 37.0242L11.5136 38.1189L5.53544 42.7204Z" fill="currentColor"></path>
                                    <path d="M30.9098 42.7204L24.9316 38.1189L26.3538 37.0242L32.3319 41.6257L30.9098 42.7204Z" fill="currentColor"></path>
                                </svg>
                            </span>
                            <h2 class="categories__title">المحرك</h2>
                        </a>
                    </div>
                </div>
                <div class="">
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-6 order-lg-2">
                    <div class="about__thum">
                        <div class="about__thumb--items">
                            <img class="about__thumb--img border-radius-5" src="' . $uri . '/assets/img/service-2.png" alt="about-thumb">
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 mt-4 mt-md-0">
                    <div class="about__content">
                        <h2 class="about__content--maintitle mb-25">خصومات حصرية</h2>
                        <p class="about__content--desc mb-20">حصرياً لعملائنا نقدم خصم 32% على تغير الزيوت والفلاتر ، بالتعاون مع شركة بترومين اكسبرس.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    <div class="about__thumb ">
                        <div class="about__thumb--items">
                            <img class="about__thumb--img border-radius-5" src="' . $uri . '/assets/img/service-3.png" alt="about-thumb">
                        </div>
                    </div>
                </div>
                <div class="col-lg-5  mt-4 mt-md-0">
                    <div class="about__content">
                        <h2 class="about__content--maintitle mb-25">خدمات المساندة على الطريق</h2>
                        <p class="about__content--desc mb-20">تم منح هذه الخدمة مجاناً ولعدد غير محدود وفي أي وقت لعملائنا، لتلافي استغلال بعض السطحات للأعطال التي قد يتعرض لها عملاؤنا وخصوصاً خارج المدينة برفع أسعار نقل السيارة أثناء تعطلها والتي قد تصل إلى 1000 ريال للمرة الواحدة.</p>
                        <p class="about__content--desc mb-20">تقدم لك الخدمة من خلال شبكة تغطي جميع مناطق المملكة. وتغطي الخدمة الحالات التالية :</p>
                        <ul class="list-group list-group-borderless list-group-icon-primary-bg">
                            <li class="list-group-item ">
                                <svg width="29" height="29" viewbox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_100_360)">
                                        <circle cx="14.0879" cy="14.5398" r="14" fill="#EEEEEA"/>
                                        <path d="M7.73153 15.4272L12.5446 18.9887L19.6075 10.0911" stroke="#D7442A" stroke-width="2"/>
                                    </g>
                                    <defs>
                                        <clipPath id="clip0_100_360">
                                            <rect width="28" height="28" fill="white" transform="translate(0.0878906 0.539795)"/>
                                        </clipPath>
                                    </defs>
                                </svg>
                                <span>الأعطال الميكانيكية.</span>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-2">
                    <div class="about__thumb ">
                        <div class="about__thumb--items">
                            <img class="about__thumb--img border-radius-5" src="' . $uri . '/assets/img/service-4.png" alt="about-thumb">
                        </div>
                    </div>
                </div>
                <div class="col-lg-10">
                    <div class="about__content">
                        <h2 class="about__content--maintitle mb-25">عازل حراري مجاناً</h2>
                        <p class="about__content--desc mb-20">عازل حراري مجاني يشمل الزجاج الجانبي والخلفي بضمان 10 سنوات من أجود أنواع العوازل الامريكية بالاضافة لخصم 30% على الخدمات الاخرى من شركة VIP الامريكية .</p>
    ...
    <div class="bg-light section--padding">
        <div class="container">
            <h3 class="text-center col-md-6 m-auto py-5">لا يشترط لامتلاك هذه البـــاقة شــراء الســيارة ولكن يشـــترط ان تكــــــــون الســـــيارة جديـــــدة</h3>
            <div class="row col-md-10 m-auto  mb-3 text-center">
                ' . $packages_html . '
            </div>
        </div>
    </div>

    <div class="brand__section section--padding">
        <div class="container">
            <div class="section__heading  mb-30 ">
                <h2 class="section__heading--maintitle text-center col-md-10 m-auto">
                    كما تقدم هذه الباقة بخصومات مختلفة على سيارات مختارة لمنسوبي الجهات التالية:
                </h2>
            </div>
            <div class="brand__section--inner brand__section-slides">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="card border pb-3 text-center p-3">
                            <img class="brang__logo--img" src="' . $uri . '/assets/img/partners/1.png" alt="bank-logo">
                            <h4>وزارة التجارة</h4>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="card border pb-3 text-center p-3">
                            <img class="brang__logo--img" src="' . $uri . '/assets/img/partners/2.png" alt="bank-logo">
                            <h4>وزارة الشؤون البلدية والقروية والإسكان</h4>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="card border pb-3 text-center p-3">
                            <img class="brang__logo--img" src="' . $uri . '/assets/img/partners/3.png" alt="bank-logo">
                            <h4>وزارة التجارة</h4>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="card border pb-3 text-center p-3">
                            <img class="brang__logo--img" src="' . $uri . '/assets/img/partners/4.png" alt="bank-logo">
                            <h4>وزارة الشؤون البلدية والقروية والإسكان</h4>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="card border pb-3 text-center p-3">
                            <img class="brang__logo--img" src="' . $uri . '/assets/img/partners/5.png" alt="bank-logo">
                            <h4>وزارة التجارة</h4>
                        </div>
                    </div>
                    <div class="swiper-slide">
...
add_shortcode('car-services', 'services_shortcode');