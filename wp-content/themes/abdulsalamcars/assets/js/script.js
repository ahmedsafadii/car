...
window.addEventListener("load", function() {
    var swiper_slider = new Swiper(".hero__slider--activation-1", {
        slidesPerView: 1,
        loop: !0,
        clickable: !0,
        speed: 500,
        spaceBetween: 50,
        pagination: {el: '.navSocails .swiper-pagination', clickable: true}
    })
...
var swiper = new Swiper(".hero__slider--activation", {
    ...
    swiper = new Swiper(".brand__section-slides", {
        slidesPerView: 7,
        clickable: !0,
        spaceBetween: 30,
        breakpoints: {
    ...
    document.querySelectorAll("[data-countdown]").forEach(function (elem) {
        const countDownItem = function (value, label) {
            ...
            countDownInterval = setInterval(function () {
                ...
                (elem.innerHTML =
                    countDownItem(daysValue, "أيام") +
                    countDownItem(hoursValue, "ساعات") +
                    countDownItem(minutesValue, "دقائق") +
                    countDownItem(secondsValue, "ثواني")),
